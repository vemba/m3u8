...
from m3u8.model import M3U8, Playlist, IFramePlaylist, Media, Segment, AdSignal, Key, SegmentList
from m3u8.parser import parse, is_url, ParseError

PYTHON_MAJOR_VERSION = sys.version_info

__all__ = ('M3U8', 'Playlist', 'IFramePlaylist', 'Media',
           'Segment', 'loads', 'load', 'parse', 'ParseError', 'AdSignal', 'Key', 'SegmentList')
